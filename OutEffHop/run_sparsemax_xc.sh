...
~/.conda/envs/outlier/bin/python -V
...
--with_tracking \
--report_to wandb \
--run_name test_oasis_llama3_1b_sparsemax_xc \
--extra_tb_stats \
--seed 1000 \
...
--output_dir /scratch/hlv8980/residual/output/oasis_llama3_sparsemax_xc \
--resume_from_checkpoint /scratch/hlv8980/residual/output/oasis_llama3_sparsemax_xc/checkpoints/checkpoint_200
...
# --output_dir output_metrics/oasis_llama3_sparsemax_xc_quant
